...
const ProgramSearch = ({ filter, setFilter, setPage, page }) => {
  const handleChange = (e) => {
    setPage(0);
    let url = new URL(window.location.href);
    url.searchParams.set("page", 0);
    let newFilters = { ...filter, [e.target.name]: e.target.value };
    let json = JSON.stringify(newFilters, null, 0);
  ...
  const handleClearAll = () => {
    ...
    url.searchParams.set("q", JSON.stringify(resetFilters, null, 0));
    window.history.replaceState(null, null, url.toString());
    ...
    <Card sx={{ borderRadius: 0 }}>
      ...
      >
        <Typography
          variant="h5"
          gutterBottom
          sx={{ textAlign: "center", color: "#FFF", marginTop: 1 }}
        >
        ...
        <Grid container spacing={1} sx={{ marginTop: 3 }}>
          <Grid item xs={12} sm={12} md={12}>
            <TextField
              placeholder="Search by Keyword, Team or Program Name"
              variant="outlined"
              value={filter.search}
              name="search"
              fullWidth
                    ...
                    <FormControl sx={{ width: "100%" }} size="small">
                      ...
                      >
                        <MenuItem value={"In person"}>
                          <Checkbox
                            checked={filter.format.includes("In person")}
                          />
                          <ListItemText primary="In person" />
                        </MenuItem>
                        <MenuItem value={"Online"}>
                          <Checkbox
                            checked={filter.format.includes("Online")}
                          />
                          <ListItemText primary="Online" />
                        </MenuItem>
                        <MenuItem value={"Multiple modalities"}>
                          <Checkbox
                            checked={filter.format.includes(
                              "Multiple modalities"
                            )}
                          />
                        ...
                        <MenuItem value={"Self Directed"}>
                          <Checkbox
                            checked={filter.format.includes("Self Directed")}
                          />
                          <ListItemText primary="Self Directed" />
                        </MenuItem>
                        <MenuItem value={"Social Learning"}>
                          <Checkbox
                            checked={filter.format.includes("Social Learning")}
                          />
                    ...
                    <FormControl sx={{ width: "100%" }} size="small">
                      ...
                      >
                        <MenuItem value={"Customer Obsession"}>
                          <Checkbox
                            checked={filter.leaderships.includes(
                              "Customer Obsession"
                            )}
                          />
                        ...
                        <MenuItem value={"Ownership"}>
                          <Checkbox
                            checked={filter.leaderships.includes("Ownership")}
                          />
                        ...
                        <MenuItem value={"Think Big"}>
                          <Checkbox
                            checked={filter.leaderships.includes("Think Big")}
                          />
                        ...
                        <MenuItem value={"Frugality"}>
                          <Checkbox
                            checked={filter.leaderships.includes("Frugality")}
                          />
                          <ListItemText primary="Frugality" />
                        </MenuItem>
                        <MenuItem value={"Earn Trust"}>
                          <Checkbox
                            checked={filter.leaderships.includes("Earn Trust")}
                          />
                          <ListItemText primary="Earn Trust" />
                        </MenuItem>
                        <MenuItem value={"Dive Deep"}>
                          <Checkbox
                            checked={filter.leaderships.includes("Dive Deep")}
                          />
